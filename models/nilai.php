<?php
class Nilai {
    static function getRataPelajaran($nis, $pelajaran,$tipe='') {
    ...
    static function getRataKD($kd, $nis, $tipe='', $array = true) {
        $nis        = mysql_real_escape_string($nis);
    ...
    static function getRataSK($id, $nis, $tipe='',  $array = true) {
    ...
    static function getNilai_Optimun ($nis, $pelajaran,$tipe='') {
        $nis = mysql_real_escape_string($nis);
    ...
    static function getRata_OptiSK($id, $nis, $tipe='',  $array = true) {
        $nis = mysql_real_escape_string($nis);
    ...
    static function getOptimumKD($kd, $nis, $tipe='', $array = true) {
    ...
    static function getNilai_Ketrampilan($tipe, $nis, $kd, $status) {
        $result=array();
        $nis = mysql_real_escape_string($nis);
    ...
    static function getNilaiAkhir($nis, $pelajaran, $jenis) {
