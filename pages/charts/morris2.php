      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href=""><i class="fa fa-circle-o"></i> 2016/2017</a>
                <ul class="treeview-menu">
                  <li><a href="morris.php"><i class="fa fa-circle-o"></i> Semester Ganjil</a></li>
                  <li class="active"><a href="morris2.php"><i class="fa fa-circle-o"></i> Semester Genap</a></li>
                </ul>
            </li>
          </ul>
        </li>
